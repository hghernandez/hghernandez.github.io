...
save(estacionalidad,file= paste0(ruta,"2022-07-30-analisis-de-estacionalidad/estacionalidad.RData"))
...
save(heatmap_calendar,file= paste0(ruta,"2022-07-30-analisis-de-estacionalidad/heat_map.RData"))
